...
basic_col<- feglm(anxious ~ group + factor(female) + factor(hispanic) + factor(had_covid) + factor(employed) + factor(prescription) + age, data = reg_samp)
```
...
basic_full <- feglm(anxious ~ group + factor(educ) + factor(female) + factor(hispanic) + factor(had_covid) + factor(employed) + factor(prescription) + age, data = reg_samp_comp)

### Add state fixed effects

fe_full<- feglm(anxious ~ group + factor(educ) + factor(female) + factor(hispanic) + factor(had_covid) + factor(employed) + factor(prescription) + age | state, data = reg_samp_comp)

fe_col <- feglm(anxious ~ group + factor(female) + factor(hispanic) + factor(had_covid) + factor(employed) + factor(prescription) + age | state, data = reg_samp)
```
...
```{r paged.print=FALSE}
etable(basic_col, basic_full, fe_col, fe_full)
```