...
basic_full <- feglm(anxious ~ group + factor(educ) + factor(female) + factor(hispanic) + factor(had_covid) + factor(employed) + factor(prescription) + age, data = comp)

### Add state fixed effects

fe_full<- feglm(anxious ~ group + factor(educ) + factor(female) + factor(hispanic) + factor(had_covid) + factor(employed) + factor(prescription) + age | state, data = comp)
