...
df <- df %>%
  mutate(race_comb = ifelse(race_c == "Asian", 3, 0)) %>%
  mutate(race_comb = ifelse(race_w == "White", 1, race_comb)) %>%
  mutate(race_comb = ifelse(race_am == "American Indian or Alaska Native", 4, race_comb)) %>%
  mutate(race_comb = ifelse(race_b == "Black or African American", 2, race_comb)) %>%
  mutate(race_comb = ifelse(race_h == "Native Hawaiian or Pacific Islander", 4, race_comb)) %>%
  mutate(race_comb = ifelse(race_o == "Other", 4, race_comb))
